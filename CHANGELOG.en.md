...
All public release notes for the opensource package are recorded here. The project follows [Semantic Versioning](https://semver.org/).
...
- aligned the opensource package and the current workspace runtime to `5.405`
- included the latest KEY-007 improvements: adaptive KNN, walk-forward phase gate, and per-plugin×symbol accuracy matrix/heatmap reporting
- regenerated the source archive as `gcc_evolution_v5405.zip`

## [5.400] - 2026-03-11

### Changed

- bumped the opensource source version to `5.400`
- updated the main user manual entrypoints to `v5.400`
