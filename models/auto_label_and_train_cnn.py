...
CONFIG = {
    ...
    "symbols": {
        ...
        "crypto": [
            ...
            "ADA-USD", "XRP-USD", "DOT-USD", "AVAX-USD",
            "MATIC-USD", "LINK-USD", "UNI-USD", "ATOM-USD",
        ],
        # 美股 (数据相对少)
        "stocks": [
            "TSLA", "AMD", "NVDA", "AAPL", "MSFT", "GOOGL","CRWV",
            "META", "AMZN", "COIN", "MARA", "RIOT", "SQ","OPEN",
        ],
    },
    ...
    "future_klines": 10,          # 用于判断标签的未来K线数
    "samples_per_symbol": 100,    # 每个品种每个周期的采样数
    
    # 标签阈值
    "up_threshold": 0.015,        # 涨幅 > 1.5% → UP
    "down_threshold": -0.015,     # 跌幅 > 1.5% → DOWN
