...
def compute_valuation_layer(
    ...
    """
    KEY-003-T02 baseline implementation.

    PRD v1.1 formula:
    - Valuation_Raw = sum(indicator_score_i * indicator_weight_i)
    - indicator_score_i is clipped to [-2, +2]
    - Raw_MaxAbs = sum(2 * indicator_weight_i)
    - Valuation_Score = clip(10 * Raw / Raw_MaxAbs, -10, +10)
    """
